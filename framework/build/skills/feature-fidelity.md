...
| [`ui-best-practices.md`](../../design/skills/ui-best-practices.md) | UI best practices + feature fidelity work together: ui-best-practices defines what states must exist; feature-fidelity verifies the implementation matches the design spec exactly |