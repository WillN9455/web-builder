...
> that drive the stack decision in `framework/build/config/config-rules.md`.
...
**Cross-references:** `PRD/<project>/rbac-matrix.md`; `data-model.md` CRUD column; `business-rules.md` BR-04x (eligibility); `framework/shared/skills/security.md` §RBAC / §IDOR
